class FlatsController < ApplicationController
  ...
  def index
    # @flats = Flat.all
    @flats = Flat.geocoded # @flats = Flat.wherenot(lat: nil, lng: nil) returns us an array of instances of  flats with coordinates
    @markers = @flats.map do |flat|
      ...
      } #markers object is a big array of baby hashes, baby hashes contianing latitude and longitude
    end
  end
